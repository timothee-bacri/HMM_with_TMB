...
```{r 4generate_sample-original, eval=FALSE}
...
To ensure that $\hat{\b{\lambda}}$ are kept in ascending order, we refer to our Section [Label Switching](#label-switching) for a solution.
