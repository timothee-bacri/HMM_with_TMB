...
Additionally, as a by-product of using `TMB`, we can derive standard errors and hence confidence intervals for smoothing probabilities (as defined in [local-decoding]).
