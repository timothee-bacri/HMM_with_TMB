...
A preprint version of an article that will (hopefully) be published soon can be found along with the code of its results in the folder [paper2-github-preprint/](https://github.com/timothee-bacri/HMM_with_TMB/blob/main/paper2-github-preprint).
