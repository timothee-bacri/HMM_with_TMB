...
```
Restarting the `R` session via the menu `Session->Restart R` (shortcut `Ctrl+Shift+F10`) will also unload the file, but you will need to load again the `TMB` package.
