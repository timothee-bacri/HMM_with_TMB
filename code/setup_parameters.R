...
# Number of benchmark runs used to time the estimation of HMM parameters
BENCHMARK_SAMPLES <- 100
# BENCHMARK_SAMPLES <- 4

# Number of bootstrap samples used to obtain confidence intervals
BOOTSTRAP_SAMPLES <- 500
# BOOTSTRAP_SAMPLES <- 4

# Number of confidence intervals used to obtain coverage probabilities
COVERAGE_SAMPLES <- 200
# COVERAGE_SAMPLES <- 20

# Number of benchmarks checking timing reliability
CONSISTENCY_BENCHMARK_LAMB <- 1000
CONSISTENCY_BENCHMARK_SIMU <- 1000
CONSISTENCY_BENCHMARK_HOSP <- 1000
CONSISTENCY_BENCHMARK_TINN <- 100
