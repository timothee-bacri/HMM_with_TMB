...
if (RUN_LAMB) {
  ...
  save(M_LIST_LAMB, estim_benchmarks_df_lamb, coverage_skips_lamb,
       conf_int_lamb,
...
if (RUN_SIMULATION1) {
  ...
  save(M_LIST_SIMU1, estim_benchmarks_df_simu1, coverage_skips_simu1,
       conf_int_simu1,
...
if (RUN_TINNITUS) {
  ...
  save(M_LIST_TINN, estim_benchmarks_df_tinn, coverage_skips_tinn,
       conf_int_tinn, consistency_estim_benchmarks_df_tinn,
