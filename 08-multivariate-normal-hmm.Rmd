...
Most notably, distribution parameters are changed from $\bs{\lambda}$ to $\bs{\mu}$ and $\bs{\Sigma}$.
...
Note that the matrix results (for $\bs{delta$ $\bs{Gamma}$ and $\{Sigma$) are displayed in a column-wise format.
