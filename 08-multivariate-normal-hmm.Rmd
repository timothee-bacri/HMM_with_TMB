...
Let 2 Gaussian distributions $N(\bs{\mu_1}, \bs{\Sigma_1})$ and $N(\bs{\mu_2}, \bs{\Sigma_2})$ be defined with parameters as follows.
\begin{equation*}
\bs{\mu} =
\begin{pmatrix}
\bs{\mu_1}\\
...
Let a stationary Markov chain's TPM be defined as follows.
\begin{equation*}
\bs{\Gamma} =
\begin{pmatrix}
0.95 & 0.05\\
